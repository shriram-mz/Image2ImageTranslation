...
class DataLoader:
    def __init__(self, data_root, image_size, batch_size, paired=True, train=True, semantics=False):   #removed , folder_A = "real_A/", folder_B = "fake_B/"
        '''
        Parameters:
        ...
        if semantics:
            self.train_names = glob.glob(self.data_path + '/*') #removed images/*
        ...
        #         self.names = self.train_test['test']
            ...
            self.names = os.listdir("/home/mz/sim2real/dataset/carla")
            print(self.names)
    ...
    def data_generator(self, iteration, train = True):
        ...
        images_dir = root       #+ self.folder_A removed
        labels_dir = root       # + self.folder_B removed
